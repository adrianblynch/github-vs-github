...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Scoreboard = __webpack_require__(170);

	var _Scoreboard2 = _interopRequireDefault(_Scoreboard);

	var _fixtures = __webpack_require__(172);
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				this.setState(_fixtures2.default);
			}
		}, {
			key: 'addUserIfNotPresent',
			value: function addUserIfNotPresent(user) {
				if (!this.userExists(user)) {
					this.setState({
						users: [].concat(_toConsumableArray(this.state.users), [user]).sort(this.sortByStarCount)
					});
				}
			}
		}, {
			key: 'userExists',
			value: function userExists(userToAdd) {
				return this.state.users.find(function (user) {
					return user.username === userToAdd.username;
				}) !== undefined;
			}
		}, {
			key: 'sortByStarCount',
			value: function sortByStarCount(a, b) {
			...
			value: function handleSearch(event) {
				...
				if (event.key === 'Enter' || event.type === 'click') {
					(function () {
						...
						var node = _reactDom2.default.findDOMNode(_this2.refs.username);
						var username = node.value.trim();
						fetch('https://api.github.com/users/' + username + '/repos?per_page=100').then(function (res) {
							return res.json();
						}).then(function (json) {
							return _this2.handleReposResponse(json, username);
						}) // Note: Why am I passing `username` through? Because `mapReposToUser` needs it! This is nasty!
						.catch(function (err) {
							return _this2.handleReposFailure(node, 'warn');
						}).then(function () {
							return node.value = '';
						});
					})();
			...
			key: 'handleReposResponse',
			value: function handleReposResponse(repos) {
				this.addUserIfNotPresent(this.mapReposToUser(repos));
			}
		}, {
			key: 'handleReposFailure',
			value: function handleReposFailure(node, className) {
				node.classList.remove(className);
				setTimeout(function () {
					return node.classList.add(className);
				}, 0); // Note: http://stackoverflow.com/questions/17296576/css3-transition-doesnt-work-when-i-remove-class-of-newly-created-element
			}
		}, {
			key: 'mapReposToUser',
			value: function mapReposToUser(repos) {
				return {
					username: repos[0].owner.login,
					avatarUrl: repos[0].owner.avatar_url,
					starCount: repos.reduce(function (count, repo) {
			...
			key: 'removeUser',
			value: function removeUser(event) {
				// Note: Go see the comment in ScoreboardItem to read my disgust on passing the event and not something more meaningful
				var username = event.target.value;
				var users = [].concat(_toConsumableArray(this.state.users.filter(function (user) {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_Scoreboard2.default, { users: this.state.users, removeUser: this.removeUser })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ScoreboardItem = __webpack_require__(171);

	var _ScoreboardItem2 = _interopRequireDefault(_ScoreboardItem);
	...
	var Scoreboard = function (_React$Component) {
		...
		function Scoreboard() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(Scoreboard).apply(this, arguments));
		}
		...
		_createClass(Scoreboard, [{
			...
			value: function render() {
				...
				var users = this.props.users.map(function (item, index) {
					return _react2.default.createElement(_ScoreboardItem2.default, {
						position: index + 1,
						user: item,
						key: index,
						removeUser: _this2.props.removeUser
					});
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoreboardItem = function (_React$Component) {
		_inherits(ScoreboardItem, _React$Component);

		function ScoreboardItem() {
			_classCallCheck(this, ScoreboardItem);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ScoreboardItem).call(this));
		}

		_createClass(ScoreboardItem, [{
			key: "render",
			value: function render() {
				...
				return _react2.default.createElement(
					"li",
					null,
					_react2.default.createElement("img", { src: user.avatarUrl, width: "100", height: "100" }),
					_react2.default.createElement(
						"button",
						{ onClick: this.props.removeUser, value: user.username },
						"X"
					),
					" ",
					_react2.default.createElement(
	...
	exports.default = ScoreboardItem;
...
/***/ function(module, exports) {
	...
	module.exports = {
		"users": [
			{
				"username": "jquery",
				"avatarUrl": "https://avatars.githubusercontent.com/u/70142?v=3",
				"starCount": 80978,
				"ownReposCount": 49,
				"homeUrl": "https://github.com/jquery"
			},
			{
				"username": "adrianblynch",
				"avatarUrl": "https://avatars.githubusercontent.com/u/4160967?v=3",
				"starCount": 43,
				"ownReposCount": 100,
				"homeUrl": "https://github.com/adrianblynch"
			},
			{
				"username": "clarkie",
				"avatarUrl": "https://avatars.githubusercontent.com/u/2292639?v=3",
				"starCount": 21,
				"ownReposCount": 47,
				"homeUrl": "https://github.com/clarkie"
			},
			{
				"username": "owenDods",
				"avatarUrl": "https://avatars.githubusercontent.com/u/9574149?v=3",
				"starCount": 1000000,
				"ownReposCount": 3,
				"homeUrl": "https://github.com/owenDods"
			}
		]
	};
